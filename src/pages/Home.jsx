    ...
    <div className="">
      ...
      <main className="bg-white flex flex-col md:flex-row   ">
        ...
        <section>
          ...
          <h3 className='text-xl md:text-3xl text-center  py-10'>Mi nombre artístico es <span className='font-bold text-teal-600'>zotari</span>, aquí tienes algunas de mis obras...</h3>
